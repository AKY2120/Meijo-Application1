...
import jp.ac.meijou.android.s241205066.databinding.ActivityMain4Binding;
import jp.ac.meijou.android.s241205066.databinding.ActivityMain5Binding;
import okhttp3.Call;
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                Optional.ofNullable(gist)
                        ...
                        .ifPresent(gistFile -> {
                            ...
                            runOnUiThread(() -> binding.textViewNET.setText(gistFile.content));
                        });
            }
        });
    }
